...
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='praneeth2578@gmail.com')
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='')
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='praneeth2578@gmail.com')

# For development, use console backend only if no email password is set
if ENVIRONMENT == 'development' and not env('EMAIL_HOST_PASSWORD', default=''):
